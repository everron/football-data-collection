...
class PlayerSpider(scrapy.Spider):
    ...
    baseUrlSoFifa = 'https://sofifa.com/players?keyword='
    ...
    allowed_domains = ["https://sofifa.com",
                       "sofifa.com",
                       "http://www.sofifa.com",
                       "https://sofifa.com/",
                       "sofifa.com/",
        ...
        with playerFile:
            ...
            while playerIndex <= (self.lastPlayerIndex-1):
                ...
                if self.parseSoFifaLinkFromFile:
                    ...
                    fifaId = fifaIdList[0]
                    #url = 'https://sofifa.com/player/' + fifaId
        ...
        try:
            ...
            if self.searchEngine is not None:           
                if self.searchEngine == 'Google':
                    ...
                    fifaId = fifaIdList[0]
                    playerUrl = 'https://sofifa.com/player/' + str(fifaId)
    ...
    def parsePlayerFromSearchEngine(self,response):
        ...
        for fifaId in fifaIdList[:self.searchEngineResultLimit]:
            url = 'https://sofifa.com/player/' + fullHrefLink[idx]+'?hl=en-US'
            yield scrapy.Request(url, 
                                 callback=self.parsePlayerFromSoFifa,
                                 dont_filter = True,
